                            ...
                            <div class="col-lg-9">
                                <div class="p-20">
                                    ...
                                    if (isset($_POST['submit'])) {
                                        ...
                                        $insert = mysqli_query($koneksi, "INSERT INTO customer SET nama_customer='$nama_customer', alamat='$alamat', hp='$hp'");
                                        if ($insert) {
                                    ?>
                                            <div class="alert alert-success alert-dismissable">
                                                <button type="button" class="close" data-dismiss="alert" aria-hidden="true">×</button>
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="card-box table-responsive">
                        <h4 class="header-title m-t-0 m-b-30">Daftar Customer</h4>
                        ...
                        <table id="datatable-buttons" class="table table-striped table-bordered">
                            ...
                            <tbody>
                                <?php
                                $text = mysqli_query($koneksi, "SELECT * FROM customer ORDER BY id DESC");
                                ...
                                ?>
                                        <tr>
                                            ...
                                            <td align="center" width="50"><?php echo $db['nama_customer']; ?></td>
                                            ...
                                            <td align="center">
                                                <div style="display:flex; justify-content:center; align-items:center; gap:5px; flex-wrap:nowrap; min-width:80px;">
                                                    ...
                                                    <?php if ($can_delete) { ?>
                                                        <a href="?page=customer&hapus=<?php echo $db['id']; ?>"
