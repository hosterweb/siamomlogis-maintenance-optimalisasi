            ...
            <div class="content-page">
                ...
                <div class="content">
                    ...
                    <div class="row">
							<div class="col-sm-12">
								<div class="card-box">
                                    <h4 class="header-title m-t-0 m-b-30">Kode COA</h4>
...
$insert=mysqli_query($koneksi,"INSERT INTO coa SET kode_coa='$kode_coa', keterangan='$keterangan'");
												if($insert){
												?>
												<div class="alert alert-success alert-dismissable">
	                                            <button type="button" class="close" data-dismiss="alert" aria-hidden="true">×</button>
	...
	$cariid=mysqli_query($koneksi, "SELECT id FROM coa WHERE id=(SELECT max(id) FROM coa)");	
...
<div class="col-lg-8">
<input  type="text" class="form-control" name="kode_coa" id="kode_coa" value="KD-<?php echo $kodecoa;?>">
</div></div>
						...
						<div class="row">
                            <div class="col-sm-12">
                                <div class="card-box table-responsive">
                        			<h4 class="header-title m-t-0 m-b-30">Daftar Kode COA</h4>
                                    <table id="datatable-buttons" class="table table-striped table-bordered">
                                        ...
                                        <tbody>
                                           <?php
	$text = mysqli_query($koneksi,"SELECT * FROM coa order by id DESC");
...
<td align="center" width="150" ><?php echo $db['kode_coa']; ?></td>
<td><?php echo $db['keterangan']; ?></td>
<td align="center" width="80">
            <?php
	$level=$_SESSION['level'];		
	$j10 = mysqli_query($koneksi,"SELECT * FROM permis where menu='coa' AND user='$level'");
	$data10=mysqli_fetch_array($j10);
    if($data10['u']=='y'){ 
	?>     
		<a href="?page=edit_coa&edit=<?php echo $db['id'];?>">
<i class="fa fa-pencil"></i></a>
     <?php }?>  
             <?php
			 $level=$_SESSION['level'];	
	$j2 = mysqli_query($koneksi,"SELECT * FROM permis where menu='coa' AND user='$level'");
	$data8=mysqli_fetch_array($j2);
	 if($data8['d']=='y'){ 
	?>
<a href="?page=coa&hapus=<?php echo $db['id'];?>">
