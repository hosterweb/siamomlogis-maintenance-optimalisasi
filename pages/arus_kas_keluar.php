            ...
            <div class="content-page">
                ...
                <div class="content">
                    ...
                    <div class="row">
							<div class="col-sm-12">
								<div class="card-box">
                                    <h4 class="header-title m-t-0 m-b-30">Tambah Kas Keluar</h4>
									...
									<div class="row">
										<div class="col-lg-9">
											...
											if (isset($_GET['hapus'])) {
											$id_hapus=$_GET['hapus'];
											$ex=mysqli_query($koneksi,"DELETE FROM arus_kas_keluar WHERE id='$id_hapus'");
											if($ex){
												?>
...
$sisa_saldo=str_replace(",","",$ambil['sisa_saldo']);
$saldo_akhir=$sisa_saldo-$nominal;
$saldo_awal=$ambil['sisa_saldo'];													
$insert=mysqli_query($koneksi,"INSERT INTO arus_kas_keluar SET deskripsi='$deskripsi', nama_bank='$nama_bank', no_rekening='$no_rekening', saldo_awal='$saldo_awal', nominal='$nominal', sisa_saldo='$saldo_akhir', tgl='$tgl'");

mysqli_query($koneksi,"UPDATE saldo_awal_mom SET sisa_saldo='$saldo_akhir' where nama_bank='$nama_bank' AND no_rekening='$no_rekening'");												
						...
						<div class="row">
                            <div class="col-sm-12">
                                <div class="card-box table-responsive">
                        			<h4 class="header-title m-t-0 m-b-30">Arus Kas Keluar</h4>
                                    <table id="datatable-buttons" class="table table-striped table-bordered">
                                        ...
                                        <tbody>
                                           <?php
	$text = mysqli_query($koneksi,"SELECT * FROM arus_kas_keluar order by id DESC");
...
<td align="center" width="80">
    ...
    if($data10['u']=='y'){ 
	?>     
		<a href="?page=edit_arus_kas_keluar&edit=<?php echo $db['id']; ?>">
<i class="fa fa-pencil"></i></a>
	...
	$data8=mysqli_fetch_array($j2);
	 if($data8['d']=='y'){ 
	?>
<a href="?page=arus_kas_keluar&hapus=<?php echo $db['id']; ?>">
