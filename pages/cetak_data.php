...
?>
<title>Invoice Number  <?php echo $r_data['invoice_number'];?></title>
<img src="assets/images/kop.png">
...
<td width="2%">:</td>
<td width="48%"><?php  echo $r_data['loding'];  ?></td>
</tr>
<tr>
<td width="30%" style="padding-left:5px">POD</td>
<td width="2%">:</td>
<td width="48%"><?php  echo $r_data['destination'];  ?></td>
</tr>
<tr>
...
?>   <div></div>
    <tr style="padding-left:3px;">
        <td align="center" style="font-size:11pt; border:1px solid #000; width:75%; text-align:left; padding-left:5px; font-weight:bold;">
		<?php 
...
<tr>
<td style="font-size:11pt; padding-left:5px">Total</td> 
<td align="right" style="font-size:11pt; font-weight:bold;"> <?php echo $r_data['currency'];  echo "&nbsp;";echo "&nbsp;";echo "&nbsp;"; echo number_format($j+$pajak);?></td>
</tr>
...
<tr><td style="width:50%; font-size:10pt;" width="75%">
 ...
 <td width="25%" style="font-size:10pt;"><br>Surabaya, <?php 
$tgl=$r_data['tgl'];
