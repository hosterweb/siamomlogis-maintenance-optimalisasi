...
<td align="center" width="80">
    ...
    if($data10['u']=='y'){ 
	?>     
			<a href="?page=edit_entry_job&edit_id=<?php echo $db['id']; ?>">
            <button class="btn btn-custom waves-effect waves-light btn-sm" id="sa-warning"><i class="fa fa-pencil"></i> Edit</a>
     <?php }?>  
             <?php
			 $level=$_SESSION['level'];	
	...
	$data8=mysqli_fetch_array($j2);
	 if($data8['d']=='y'){ 
	?>
<a href="?page=create_job&hapus=<?php echo $db['id'];?>">
