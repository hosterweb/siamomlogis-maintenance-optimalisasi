            ...
            <div class="content-page">
                ...
                <div class="content">
                    ...
                    <div class="row">
							<div class="col-sm-12">
								<div class="card-box">
                                    <h4 class="header-title m-t-0 m-b-30">Edit Arus Kas Keluar</h4>
...
$insert=mysqli_query($koneksi,"UPDATE arus_kas_keluar SET deskripsi='$deskripsi', nama_bank='$nama_bank', no_rekening='$no_rekening', nominal='$nominal' where id='$id'");
												if($insert){
												?>
												<div class="alert alert-success alert-dismissable">
	                                            <button type="button" class="close" data-dismiss="alert" aria-hidden="true">×</button>
											...
											<?php	}
												...
												$edit=$_GET['edit'];
		$ambil_data=mysqli_query($koneksi, "SELECT * FROM arus_kas_keluar where id='$edit'");
