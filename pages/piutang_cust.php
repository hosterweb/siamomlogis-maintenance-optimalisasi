...
function rupiah($angka){	
	...
	$text = mysqli_query($koneksi,"SELECT * FROM create_job_copy where kondition='Kredit' order by id ASC");
...
<td><?php if($db['kondition']=='Kredit'){ echo "Belum Lunas";} ?></td>
<td><a href="?page=bayar_cust&id=<?php echo $db['id']; ?>"><button class="btn btn-custom waves-effect waves-light btn-sm" id="sa-warning" name="bayar"><i class="fa fa-dollar"></i></button></a></td>
</tr>
    <?php
		$no++;
		}
