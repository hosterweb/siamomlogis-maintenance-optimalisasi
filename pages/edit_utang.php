									...
									<div class="row">
										<div class="col-lg-9">
											...
											if (isset($_POST['submit'])){
													...
													$id=$_POST['id'];
$insert=mysqli_query($koneksi,"UPDATE utang SET tanggal_awal='$tanggal_awal', tgl_jatuh_tempo='$tgl_jatuh_tempo', nominal='$nominal',klien='$klien', deskripsi='$deskripsi' WHERE id='$id'");
												if($insert){
												?>
												<div class="alert alert-success alert-dismissable">
	                                            <button type="button" class="close" data-dismiss="alert" aria-hidden="true">×</button>
...
$edit=$_GET['edit'];
$ambil_data=mysqli_query($koneksi,"SELECT * FROM utang where id='$edit'");
