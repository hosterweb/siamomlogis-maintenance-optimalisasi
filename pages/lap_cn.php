...
<div class="row">
                            <div class="col-sm-12">
                                <div class="card-box table-responsive">
                        			<h4 class="header-title m-t-0 m-b-30">Laporan CN</h4>
                                    ...
                                    <table id="datatable-buttons" class="table table-striped table-bordered">
                                        ...
                                        <tbody>
                                           <?php
                                           	$tgl1= $_POST['tgl1'];	
                                               $tgl2= $_POST['tgl2'];
	$text = mysqli_query($koneksi,"SELECT * FROM cn  where tgl between '$tgl1' AND '$tgl2'");
...
<br><br><a href="pages/lap_cn_excel.php?tgl1=<?php echo $tgl1;?>&tgl2=<?php echo $tgl2;?>"><button value="Download Excel">Download Excel</button></a>                                    
                                </div>
