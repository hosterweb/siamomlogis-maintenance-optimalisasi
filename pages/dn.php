            ...
            <div class="row">
                <div class="col-sm-12">
                    ...
                    <div class="card-box table-responsive">
                        ...
                        <h4 class="header-title m-t-0 m-b-30">Daftar Debit Note</h4>
                        ...
                        <table id="datatable-buttons" class="table table-striped table-bordered">
                            ...
                            <tbody>
                                <?php
                                $text = mysqli_query($koneksi, "SELECT * FROM dn ORDER BY id DESC");
                                        ...
                                        <tr>
                                            ...
                                            <td align="center">
                                                <div style="display:flex; justify-content:center; align-items:center; gap:5px; flex-wrap:nowrap; min-width:115px;">
                                                    ...
                                                    <?php if ($can_update) { ?>
                                                        <a href="?page=edit_dn&edit=<?php echo $db['id']; ?>"
                                                    ...
                                                    <?php if ($can_delete) { ?>
                                                        <a href="?page=dn&hapus=<?php echo $db['id']; ?>"
                                                        ...
                                                        <a target="_blank"
                                                           href="pages/cetak_dn.php?&cetak_id=<?php echo $db['id']; ?>"
