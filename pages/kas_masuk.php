								...
								<div class="card-box">
									...
									<div class="row">
										<div class="col-lg-9">
											...
											if (isset($_GET['hapus'])) {
											$id_hapus=$_GET['hapus'];
											$ex=mysqli_query($koneksi,"DELETE FROM kas_masuk WHERE id='$id_hapus'");
											if($ex){
												?>
											...
											if (isset($_POST['submit'])){
													...
													$id=$_POST['id'];
$insert=mysqli_query($koneksi,"INSERT INTO kas_masuk SET tgl='$tgl', kode_coa='$kode_coa', keterangan='$keterangan', jumlah='$jumlah'");
												if($insert){
												?>
												<div class="alert alert-success alert-dismissable">
	                                            <button type="button" class="close" data-dismiss="alert" aria-hidden="true">×</button>
						...
						<div class="row">
                            <div class="col-sm-12">
                                <div class="card-box table-responsive">
                        			<h4 class="header-title m-t-0 m-b-30">Daftar Kas Masuk</h4>
                                    <table id="datatable-buttons" class="table table-striped table-bordered">
                                        ...
                                        <tbody>
                                           <?php
	$text = mysqli_query($koneksi,"SELECT * FROM kas_masuk order by id DESC");
...
<td align="center" width="80">
	...
	$j10 = mysqli_query($koneksi,"SELECT * FROM permis where menu='kas_masuk' AND user='$level'");
...
<i class="fa fa-pencil"></i></a>
     <?php }?>  
             <?php
			 $level=$_SESSION['level'];	
	$j2 = mysqli_query($koneksi,"SELECT * FROM permis where menu='kas_masuk' AND user='$level'");
