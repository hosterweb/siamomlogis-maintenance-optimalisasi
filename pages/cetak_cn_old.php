...
$olahdata=mysqli_query($koneksi, "SELECT * FROM cn where id='$cetak_id'");
...
<table border="0">
<tr><td><br /></td></tr>
<tr><td style="width:100%;font-size:20px; text-align:center;"><u>CREDIT NOTE</u></td></tr>
<tr><td align="center" style="width:100%;"><?php echo $r_data['cn_number'];?></td></tr>
<tr><td><br></td></tr>
...
<tr><td style="font-size:10pt; width:50%;">
 ...
 ACCOUNT NO : 142-00-1608363-8 (USD) <br><br>
