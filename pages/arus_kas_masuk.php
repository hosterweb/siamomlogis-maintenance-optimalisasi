            ...
            <div class="content-page">
                ...
                <div class="content">
                    ...
                    <div class="row">
							<div class="col-sm-12">
								<div class="card-box">
                                    <h4 class="header-title m-t-0 m-b-30">Tambah Kas Masuk</h4>
									...
									<div class="row">
										<div class="col-lg-9">
											...
											if (isset($_GET['hapus'])) {
											$id_hapus=$_GET['hapus'];
											$ex=mysqli_query($koneksi,"DELETE FROM arus_kas_masuk WHERE id='$id_hapus'");
											if($ex){
												?>
...
$insert=mysqli_query($koneksi,"INSERT INTO arus_kas_masuk SET deskripsi='$deskripsi', nama_bank='$nama_bank', no_rekening='$no_rekening', saldo_awal='$saldo_awal', nominal='$nominal', sisa_saldo='$sisa_saldo', tgl='$tgl'");
						...
						<div class="row">
                            <div class="col-sm-12">
                                <div class="card-box table-responsive">
                        			<h4 class="header-title m-t-0 m-b-30">Arus Kas Masuk</h4>
                                    <table id="datatable-buttons" class="table table-striped table-bordered">
                                        ...
                                        <tbody>
                                           <?php
	$text = mysqli_query($koneksi,"SELECT * FROM arus_kas_masuk order by id DESC");
...
<td align="center" width="80">
	...
	$j10 = mysqli_query($koneksi,"SELECT * FROM permis where menu='arus_kas_masuk' AND user='$level'");
	$data10=mysqli_fetch_array($j10);
    if($data10['u']=='y'){ 
	?>     
		<a href="?page=edit_arus_kas_masuk&edit=<?php echo $db['id']; ?>">
<i class="fa fa-pencil"></i></a>
     <?php }?>  
             <?php
			 $level=$_SESSION['level'];	
	$j2 = mysqli_query($koneksi,"SELECT * FROM permis where menu='arus_kas_masuk' AND user='$level'");
	$data8=mysqli_fetch_array($j2);
	 if($data8['d']=='y'){ 
	?>
		<a href="?page=arus_kas_masuk&hapus=<?php echo $db['id']; ?>">
