...
//$cariid=mysqli_query($koneksi, "SELECT * FROM create_job_copy WHERE invoice_number IS NOT NULL ORDER BY id DESC limit 1");	
...
$thnskg1=date('Y');
$blnskg1=date('m');											
$cariid=mysqli_query($koneksi, "SELECT * FROM create_job_copy WHERE YEAR(tgl)='$thnskg1' AND MONTH(tgl)='$blnskg1' AND status_invoice='1'");	
	$w=mysqli_fetch_array($cariid);
	$jum=mysqli_num_rows($cariid);
	if($jum==0) {
		$idmax=1; 
		}
		else {
...
<div style="display:none">    
 ...
 <div class="form-group">     
   ...
   <div class="col-lg-8"><input class="form-control"  type="text" name="invoice_number" id="invoice_number"  maxlength="50" value="INV/<?php echo $idmax;?>/<?php echo date("d/m/y");?>"></div></div>
